...
def start_piclisten():
    listenserver = subprocess.Popen(["python3", "/home/pi/Rpi_BrowserCam/Rpi_BrowserCam/cameralisten.py"])
    return listenserver
...
def start_servicediscovery_server():
    sdserver = subprocess.Popen(["python3", "/home/pi/Rpi_BrowserCam/Rpi_BrowserCam/servicediscovery_server.py"])
    return sdserver

def start_servicediscovery_client():
    sdclient = subprocess.Popen(["python3", "/home/pi/Rpi_BrowserCam/Rpi_BrowserCam/servicediscovery_client.py"])
    return sdclient
